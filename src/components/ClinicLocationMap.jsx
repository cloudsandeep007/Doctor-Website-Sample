...
export default function ClinicLocationMap() {
  ...
  return (
    <section id="location" className="w-full bg-slate-50 py-20 lg:py-28 border-b border-slate-200/80 scroll-mt-20">
      <div className="max-w-7xl xl:max-w-wide mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-md flex flex-col min-h-[420px] lg:min-h-[500px] relative">
            {/* Map Header Bar */}
            <div className="bg-white/95 backdrop-blur-md px-6 py-4 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
                <span className="text-sm font-bold text-slate-900">
                  Live Clinic Map: Ashok Rajpath, Patna, Bihar
                </span>
              </div>
              <a
                href={googleMapsUrl}
            ...
            <div className="bg-white p-4 sm:p-5 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-2 text-xs font-medium text-slate-600">
                ...
                <span>Ashok Rajpath Corridor • Main Road Access</span>
              </div>
              <a
                href={googleMapsUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-slate-900 hover:bg-teal-700 text-white text-xs font-bold px-5 py-2.5 rounded-full inline-flex items-center gap-1.5 shadow-sm transition-all"
              >
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-md flex-1 flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-5 flex items-center gap-2.5">
                  <span className="material-symbols-outlined text-teal-600 text-2xl">apartment</span>
                  Clinic Address &amp; Access
                </h3>

                <div className="space-y-5">
                  <div className="flex items-start gap-3.5">
                    <span className="material-symbols-outlined text-teal-600 text-xl mt-0.5">pin_drop</span>
                    <div>
                      <p className="text-sm font-bold text-slate-900">Dr. Sourav Soni Medical Clinic</p>
                  ...
                  <div className="flex items-start gap-3.5 pt-4 border-t border-slate-100">
                    <span className="material-symbols-outlined text-teal-600 text-xl mt-0.5">schedule</span>
                    <div>
                      <p className="text-sm font-bold text-slate-900">Consultation Timings</p>
                      <div className="text-sm text-slate-600 space-y-1 mt-1">
                        ...
                        <p className="text-xs text-amber-700 font-semibold mt-1">Sunday: Prior Appointment / Urgent Care</p>
                      </div>
                    </div>
                  </div>

                  <div className="flex items-start gap-3.5 pt-4 border-t border-slate-100">
                    <span className="material-symbols-outlined text-teal-600 text-xl mt-0.5">local_hospital</span>
                    <div>
                      <p className="text-sm font-bold text-slate-900">Facilities Available</p>
              ...
              <div className="pt-6 mt-6 border-t border-slate-200 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="flex-1 bg-teal-700 hover:bg-teal-800 text-white text-center py-3.5 px-4 rounded-full text-xs font-bold shadow-sm transition-colors flex items-center justify-center gap-2"
                >
                ...
                <a
                  ...
                  className="flex-1 border border-slate-300 hover:bg-slate-50 text-slate-800 text-center py-3.5 px-4 rounded-full text-xs font-bold transition-colors flex items-center justify-center gap-2"
                >
